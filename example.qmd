...
viewof i_in = Inputs.input(modelname == 'fizzbuzz' ? 0 : .02) // vs 2 for fizzbuzz!!
...
loan_spec = { return ({
  ...
  "width": "container",
  datasets: {'source': [] },
  //"transform": [{"fold": ["capital_repayment", "interest_repayment", "balance"], "as": ["key", "amount"]} // update
