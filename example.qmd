...
scene.addSignalListener("formula", (a, b) => {
  //debugger;
  set(viewof formulae_visible, ["r_inverse_length"])
  //set(viewof year_in, b.year_in[0])
  document.querySelector('.calculang_f_'+"r_inverse_length").scrollIntoView(scrollIntoViewOpts)
 //}
})
...
rays = {return [
{
      ...
      encode: {
        enter: {
          ...
          stroke: { value: "black" },
          shape: { value: "M -0.1 -0.4 L 0.3 -0.7 L 0.2 -0.1 L 0.8 0 L 0.2 0.5 L 0.2 0.9 L -0.1 0.1 L -0.3 0.6 L -0.4 -0.6" }
        },
        update: {
          x: { field: "r_hit_x", scale: "x" },
          y: { field: "r_hit_y", scale: "y" },
