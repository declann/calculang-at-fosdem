...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "keys_stream_function", function() { return keys_stream_function; });
...
/* harmony import */ var underscore__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(93);


// trig helpers:

const tan_ray_angle = ({ ray_angle_in }) => Math.tan(ray_angle({ ray_angle_in }));
const inverse_tan_ray_angle = ({ ray_angle_in }) => 1 / tan_ray_angle({ ray_angle_in });

// we use this to find the right grid lines:

const ray_looking_up = ({ ray_angle_in }) => Math.sin(ray_angle({ ray_angle_in })) > 0;
const ray_looking_right = ({ ray_angle_in }) => Math.cos(ray_angle({ ray_angle_in })) > 0;
...
const rhx = ({ step_in, f_in, keys_stream_version_in, keys_stream_function_in, ray_angle_in }) => {
  if (step({ step_in }) == 0)
...
const rhy = ({ ray_angle_in, step_in, f_in, keys_stream_version_in, keys_stream_function_in }) => {
...
const rhv = ({ step_in, f_in, keys_stream_version_in, keys_stream_function_in, ray_angle_in }) => map_lookup({ x_in: rhx({ step_in, f_in, keys_stream_version_in, keys_stream_function_in, ray_angle_in }), y_in: rhy({ ray_angle_in, step_in, f_in, keys_stream_version_in, keys_stream_function_in }) });
...
const rh_hit_object = ({ f_in, keys_stream_version_in, keys_stream_function_in, ray_angle_in }) => {
  return Object(underscore__WEBPACK_IMPORTED_MODULE_0__[/* range */ "a"])(0, 8.1).reduce(
  (acc, step_in) => {
...
const rh_hit_x = ({ f_in, keys_stream_version_in, keys_stream_function_in, ray_angle_in }) => rh_hit_object({ f_in, keys_stream_version_in, keys_stream_function_in, ray_angle_in }).x;
const rh_hit_y = ({ f_in, keys_stream_version_in, keys_stream_function_in, ray_angle_in }) => rh_hit_object({ f_in, keys_stream_version_in, keys_stream_function_in, ray_angle_in }).y;
const rh_hit_v = ({ f_in, keys_stream_version_in, keys_stream_function_in, ray_angle_in }) => rh_hit_object({ f_in, keys_stream_version_in, keys_stream_function_in, ray_angle_in }).v;
const rh_hit_step = ({ f_in, keys_stream_version_in, keys_stream_function_in, ray_angle_in }) => rh_hit_object({ f_in, keys_stream_version_in, keys_stream_function_in, ray_angle_in }).step_in;

const rh_hit_distance = ({ y_in, x_in, f_in, keys_stream_version_in, keys_stream_function_in, ray_angle_in }) =>
// Pythagoras' theorem
...
const rvx = ({ ray_angle_in, step_in, f_in, keys_stream_version_in, keys_stream_function_in }) => {
...
const rvy = ({ step_in, f_in, keys_stream_version_in, keys_stream_function_in, ray_angle_in }) => {
...
const rvv = ({ ray_angle_in, step_in, f_in, keys_stream_version_in, keys_stream_function_in }) => map_lookup({ x_in: rvx({ ray_angle_in, step_in, f_in, keys_stream_version_in, keys_stream_function_in }), y_in: rvy({ step_in, f_in, keys_stream_version_in, keys_stream_function_in, ray_angle_in }) });

// the first wall hit - vertical checks
const rv_hit_object = ({ ray_angle_in, f_in, keys_stream_version_in, keys_stream_function_in }) => {
  return Object(underscore__WEBPACK_IMPORTED_MODULE_0__[/* range */ "a"])(0, 8.1).reduce(
  (acc, step_in) => {
...
// destructure
const rv_hit_x = ({ ray_angle_in, f_in, keys_stream_version_in, keys_stream_function_in }) => rv_hit_object({ ray_angle_in, f_in, keys_stream_version_in, keys_stream_function_in }).x;
const rv_hit_y = ({ ray_angle_in, f_in, keys_stream_version_in, keys_stream_function_in }) => rv_hit_object({ ray_angle_in, f_in, keys_stream_version_in, keys_stream_function_in }).y;
const rv_hit_v = ({ ray_angle_in, f_in, keys_stream_version_in, keys_stream_function_in }) => rv_hit_object({ ray_angle_in, f_in, keys_stream_version_in, keys_stream_function_in }).v;
const rv_hit_step = ({ ray_angle_in, f_in, keys_stream_version_in, keys_stream_function_in }) => rv_hit_object({ ray_angle_in, f_in, keys_stream_version_in, keys_stream_function_in }).step_in;

const rv_hit_distance = ({ y_in, x_in, ray_angle_in, f_in, keys_stream_version_in, keys_stream_function_in }) =>
// Pythagoras' theorem
...
const r_hit_h_or_v = ({ y_in, x_in, ray_angle_in, f_in, keys_stream_version_in, keys_stream_function_in }) =>
...
const r_hit_object = ({ y_in, x_in, ray_angle_in, f_in, keys_stream_version_in, keys_stream_function_in }) =>
...
const r_hit_x = ({ y_in, x_in, ray_angle_in, f_in, keys_stream_version_in, keys_stream_function_in }) => r_hit_object({ y_in, x_in, ray_angle_in, f_in, keys_stream_version_in, keys_stream_function_in }).x;
const r_hit_y = ({ y_in, x_in, ray_angle_in, f_in, keys_stream_version_in, keys_stream_function_in }) => r_hit_object({ y_in, x_in, ray_angle_in, f_in, keys_stream_version_in, keys_stream_function_in }).y;
const r_hit_v = ({ y_in, x_in, ray_angle_in, f_in, keys_stream_version_in, keys_stream_function_in }) => r_hit_object({ y_in, x_in, ray_angle_in, f_in, keys_stream_version_in, keys_stream_function_in }).v;
const r_hit_step = ({ y_in, x_in, ray_angle_in, f_in, keys_stream_version_in, keys_stream_function_in }) => r_hit_object({ y_in, x_in, ray_angle_in, f_in, keys_stream_version_in, keys_stream_function_in }).step_in;

const fisheye_correction = ({ fisheye_correction_in }) => fisheye_correction_in;

const ray_distance = ({ y_in, x_in, ray_angle_in, f_in, keys_stream_version_in, keys_stream_function_in, fisheye_correction_in }) =>
...
const ray_inverse_distance = ({ y_in, x_in, ray_angle_in, f_in, keys_stream_version_in, keys_stream_function_in, fisheye_correction_in }) => 1 / ray_distance({ y_in, x_in, ray_angle_in, f_in, keys_stream_version_in, keys_stream_function_in, fisheye_correction_in });

/////// key controls

const keys_stream_function = ({ keys_stream_function_in }) => keys_stream_function_in;
const keys_stream_version = ({ keys_stream_version_in }) => keys_stream_version_in;

const keys = ({ keys_stream_version_in, keys_stream_function_in, f_in }) => {
  keys_stream_version({ keys_stream_version_in });
  return keys_stream_function({ keys_stream_function_in })().filter((d) => d.frame == f({ f_in }));
  //
};

const key_up = ({ keys_stream_version_in, keys_stream_function_in, f_in }) =>
...
const key_down = ({ keys_stream_version_in, keys_stream_function_in, f_in }) =>
keys({ keys_stream_version_in, keys_stream_function_in, f_in }).length ?
...
const key_left = ({ keys_stream_version_in, keys_stream_function_in, f_in }) =>
keys({ keys_stream_version_in, keys_stream_function_in, f_in }).length ?
...
const key_right = ({ keys_stream_version_in, keys_stream_function_in, f_in }) =>
keys({ keys_stream_version_in, keys_stream_function_in, f_in }).length ?
...
const forwardness = ({ keys_stream_version_in, keys_stream_function_in, f_in }) => key_up({ keys_stream_version_in, keys_stream_function_in, f_in }) ? 1 : key_down({ keys_stream_version_in, keys_stream_function_in, f_in }) ? -1 : 0;

const leftness = ({ keys_stream_version_in, keys_stream_function_in, f_in }) => key_left({ keys_stream_version_in, keys_stream_function_in, f_in }) ? 1 : key_right({ keys_stream_version_in, keys_stream_function_in, f_in }) ? -1 : 0;

const player_angle = ({ f_in, keys_stream_version_in, keys_stream_function_in }) => {
...
const player_x = ({ f_in, keys_stream_version_in, keys_stream_function_in }) => {
...
const player_y = ({ f_in, keys_stream_version_in, keys_stream_function_in }) => {
...
const ray_angle = ({ ray_angle_in }) => ray_angle_in;

const step = ({ step_in }) => Math.max(0, step_in);
...
//# sourceMappingURL=raycasting-nomemo.js.map