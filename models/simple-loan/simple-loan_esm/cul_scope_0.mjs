...
export const repayment_amount = (a) => {
  ...
  repayment_amount$({ term_in, year_in, principal_in, d_i_year_in, i_in, d_i_in, missed_repayment_year_in, skip_interest_in }); // never run, but here to "trick" calculang graph logic
};
...
export const pvifa = (a) => {
  return pvifa$m(a);
  // eslint-disable-next-line no-undef
  pvifa$({ term_in, year_in, d_i_year_in, i_in, d_i_in }); // never run, but here to "trick" calculang graph logic
};
