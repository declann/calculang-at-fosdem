    ...
    import { repayment_amount_ as repayment_amount$, pvifa_ as pvifa$, v_ as v$, v_pow_term_left_ as v_pow_term_left$, interest_ as interest$, capital_repayment_ as capital_repayment$, interest_repayment_ as interest_repayment$, repayment_due_ as repayment_due$, repayment_ as repayment$, balance_ as balance$, interest_rate_ as interest_rate$, principal_ as principal$, i_ as i$, term_ as term$, year_ as year$, missed_repayment_year_ as missed_repayment_year$, skip_interest_ as skip_interest$, d_i_year_ as d_i_year$, d_i_ as d_i$ } from './simple-loan.cul.js?+memoed'; // there is already-culed stuff in here, why? imports to memo loader include cul_scope_id, what logic should it apply RE passing forward? eliminate? Probably!
...
export const repayment_amount = (a) => {
  ...
  repayment_amount$(); // never run, but here to "trick" calculang graph logic
};
...
export const pvifa$m = memoize(pvifa$, JSON.stringify);
export const pvifa = (a) => {
  return pvifa$m(a);
  // eslint-disable-next-line no-undef
  pvifa$(); // never run, but here to "trick" calculang graph logic
};
...
export const v_pow_term_left = (a) => {
  ...
  // eslint-disable-next-line no-undef
  v_pow_term_left$(); // never run, but here to "trick" calculang graph logic
};
...
export const capital_repayment = (a) => {
  ...
  // eslint-disable-next-line no-undef
  capital_repayment$(); // never run, but here to "trick" calculang graph logic
};
...
export const interest_repayment = (a) => {
  ...
  // eslint-disable-next-line no-undef
  interest_repayment$(); // never run, but here to "trick" calculang graph logic
};
...
export const repayment_due = (a) => {
  ...
  // eslint-disable-next-line no-undef
  repayment_due$(); // never run, but here to "trick" calculang graph logic
};
...
export const repayment = (a) => {
  ...
  // eslint-disable-next-line no-undef
  repayment$(); // never run, but here to "trick" calculang graph logic
};
...
export const principal = (a) => {
  ...
  // eslint-disable-next-line no-undef
  principal$(); // never run, but here to "trick" calculang graph logic
};
...
export const term = (a) => {
  return term$m(a);
  // eslint-disable-next-line no-undef
  term$(); // never run, but here to "trick" calculang graph logic
};
...
export const missed_repayment_year = (a) => {
  ...
  // eslint-disable-next-line no-undef
  missed_repayment_year$(); // never run, but here to "trick" calculang graph logic
};
...
export const skip_interest = (a) => {
  ...
  // eslint-disable-next-line no-undef
  skip_interest$(); // never run, but here to "trick" calculang graph logic
};
...
export const d_i_year = (a) => {
  return d_i_year$m(a);
  // eslint-disable-next-line no-undef
  d_i_year$(); // never run, but here to "trick" calculang graph logic
};
...
export const d_i = (a) => {
  return d_i$m(a);
  // eslint-disable-next-line no-undef
  d_i$(); // never run, but here to "trick" calculang graph logic
};
