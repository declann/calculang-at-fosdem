...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "pvifa$m", function() { return pvifa$m; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "pvifa", function() { return pvifa; });
...
const repayment_amount$m = Object(underscore__WEBPACK_IMPORTED_MODULE_0__[/* memoize */ "a"])(_simple_loan_cul_js_memoed_cul_scope_id_1_cul_parent_scope_id_0__WEBPACK_IMPORTED_MODULE_1__[/* repayment_amount_ */ "m"], JSON.stringify);
const repayment_amount = (a) => {
  return repayment_amount$m(a);
  // eslint-disable-next-line no-undef
  Object(_simple_loan_cul_js_memoed_cul_scope_id_1_cul_parent_scope_id_0__WEBPACK_IMPORTED_MODULE_1__[/* repayment_amount_ */ "m"])({ term_in, year_in, principal_in, d_i_year_in, i_in, d_i_in, missed_repayment_year_in, skip_interest_in }); // never run, but here to "trick" calculang graph logic
};
////////// end repayment_amount memo-loader code //////////



////////// start pvifa memo-loader code //////////
//const pvifa$m = memoize(999999, isEqual)(pvifa$);
const pvifa$m = Object(underscore__WEBPACK_IMPORTED_MODULE_0__[/* memoize */ "a"])(_simple_loan_cul_js_memoed_cul_scope_id_1_cul_parent_scope_id_0__WEBPACK_IMPORTED_MODULE_1__[/* pvifa_ */ "k"], JSON.stringify);
const pvifa = (a) => {
  return pvifa$m(a);
  // eslint-disable-next-line no-undef
  Object(_simple_loan_cul_js_memoed_cul_scope_id_1_cul_parent_scope_id_0__WEBPACK_IMPORTED_MODULE_1__[/* pvifa_ */ "k"])({ term_in, year_in, d_i_year_in, i_in, d_i_in }); // never run, but here to "trick" calculang graph logic
};
////////// end pvifa memo-loader code //////////



////////// start v memo-loader code //////////
//const v$m = memoize(999999, isEqual)(v$);
const v$m = Object(underscore__WEBPACK_IMPORTED_MODULE_0__[/* memoize */ "a"])(_simple_loan_cul_js_memoed_cul_scope_id_1_cul_parent_scope_id_0__WEBPACK_IMPORTED_MODULE_1__[/* v_ */ "q"], JSON.stringify);
const v = (a) => {
  return v$m(a);
  // eslint-disable-next-line no-undef
  Object(_simple_loan_cul_js_memoed_cul_scope_id_1_cul_parent_scope_id_0__WEBPACK_IMPORTED_MODULE_1__[/* v_ */ "q"])({ year_in, d_i_year_in, i_in, d_i_in }); // never run, but here to "trick" calculang graph logic
};
...
const v_pow_term_left$m = Object(underscore__WEBPACK_IMPORTED_MODULE_0__[/* memoize */ "a"])(_simple_loan_cul_js_memoed_cul_scope_id_1_cul_parent_scope_id_0__WEBPACK_IMPORTED_MODULE_1__[/* v_pow_term_left_ */ "r"], JSON.stringify);
const v_pow_term_left = (a) => {
  return v_pow_term_left$m(a);
  // eslint-disable-next-line no-undef
  Object(_simple_loan_cul_js_memoed_cul_scope_id_1_cul_parent_scope_id_0__WEBPACK_IMPORTED_MODULE_1__[/* v_pow_term_left_ */ "r"])({ year_in, d_i_year_in, i_in, d_i_in, term_in }); // never run, but here to "trick" calculang graph logic
};
...
const repayment_due$m = Object(underscore__WEBPACK_IMPORTED_MODULE_0__[/* memoize */ "a"])(_simple_loan_cul_js_memoed_cul_scope_id_1_cul_parent_scope_id_0__WEBPACK_IMPORTED_MODULE_1__[/* repayment_due_ */ "n"], JSON.stringify);
const repayment_due = (a) => {
  return repayment_due$m(a);
  // eslint-disable-next-line no-undef
  Object(_simple_loan_cul_js_memoed_cul_scope_id_1_cul_parent_scope_id_0__WEBPACK_IMPORTED_MODULE_1__[/* repayment_due_ */ "n"])({ year_in, term_in }); // never run, but here to "trick" calculang graph logic
};
...
const repayment$m = Object(underscore__WEBPACK_IMPORTED_MODULE_0__[/* memoize */ "a"])(_simple_loan_cul_js_memoed_cul_scope_id_1_cul_parent_scope_id_0__WEBPACK_IMPORTED_MODULE_1__[/* repayment_ */ "l"], JSON.stringify);
const repayment = (a) => {
  return repayment$m(a);
  // eslint-disable-next-line no-undef
  Object(_simple_loan_cul_js_memoed_cul_scope_id_1_cul_parent_scope_id_0__WEBPACK_IMPORTED_MODULE_1__[/* repayment_ */ "l"])({ year_in, missed_repayment_year_in, skip_interest_in, principal_in, d_i_year_in, i_in, d_i_in, term_in }); // never run, but here to "trick" calculang graph logic
};
...
const term$m = Object(underscore__WEBPACK_IMPORTED_MODULE_0__[/* memoize */ "a"])(_simple_loan_cul_js_memoed_cul_scope_id_1_cul_parent_scope_id_0__WEBPACK_IMPORTED_MODULE_1__[/* term_ */ "p"], JSON.stringify);
const term = (a) => {
  return term$m(a);
  // eslint-disable-next-line no-undef
  Object(_simple_loan_cul_js_memoed_cul_scope_id_1_cul_parent_scope_id_0__WEBPACK_IMPORTED_MODULE_1__[/* term_ */ "p"])({ term_in }); // never run, but here to "trick" calculang graph logic
};
...
const year$m = Object(underscore__WEBPACK_IMPORTED_MODULE_0__[/* memoize */ "a"])(_simple_loan_cul_js_memoed_cul_scope_id_1_cul_parent_scope_id_0__WEBPACK_IMPORTED_MODULE_1__[/* year_ */ "s"], JSON.stringify);
const year = (a) => {
  return year$m(a);
  // eslint-disable-next-line no-undef
  Object(_simple_loan_cul_js_memoed_cul_scope_id_1_cul_parent_scope_id_0__WEBPACK_IMPORTED_MODULE_1__[/* year_ */ "s"])({ year_in }); // never run, but here to "trick" calculang graph logic
};
...
const skip_interest$m = Object(underscore__WEBPACK_IMPORTED_MODULE_0__[/* memoize */ "a"])(_simple_loan_cul_js_memoed_cul_scope_id_1_cul_parent_scope_id_0__WEBPACK_IMPORTED_MODULE_1__[/* skip_interest_ */ "o"], JSON.stringify);
const skip_interest = (a) => {
  return skip_interest$m(a);
  // eslint-disable-next-line no-undef
  Object(_simple_loan_cul_js_memoed_cul_scope_id_1_cul_parent_scope_id_0__WEBPACK_IMPORTED_MODULE_1__[/* skip_interest_ */ "o"])({ skip_interest_in }); // never run, but here to "trick" calculang graph logic
};
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "m", function() { return repayment_amount_; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "k", function() { return pvifa_; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "q", function() { return v_; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "r", function() { return v_pow_term_left_; });
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "n", function() { return repayment_due_; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "l", function() { return repayment_; });
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "p", function() { return term_; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "s", function() { return year_; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "i", function() { return missed_repayment_year_; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "o", function() { return skip_interest_; });
...
/* harmony import */ var _simple_loan_cul_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(0);
 // automatic refinancing: an updated calc is applied every year
const repayment_amount_ = ({ term_in, year_in, principal_in, d_i_year_in, i_in, d_i_in, missed_repayment_year_in, skip_interest_in }) => {
  if (Object(_simple_loan_cul_js__WEBPACK_IMPORTED_MODULE_0__["term"])({ term_in }) == Object(_simple_loan_cul_js__WEBPACK_IMPORTED_MODULE_0__["year"])({ year_in }) && Math.abs(Object(_simple_loan_cul_js__WEBPACK_IMPORTED_MODULE_0__["balance"])({ year_in, principal_in, d_i_year_in, i_in, d_i_in, missed_repayment_year_in, skip_interest_in, term_in }) < 0.01)) return 0;else

  return (
    Object(_simple_loan_cul_js__WEBPACK_IMPORTED_MODULE_0__["balance"])({ principal_in, d_i_year_in, i_in, d_i_in, missed_repayment_year_in, skip_interest_in, term_in, year_in: Object(_simple_loan_cul_js__WEBPACK_IMPORTED_MODULE_0__["year"])({ year_in }) - 1 }) /
    Object(_simple_loan_cul_js__WEBPACK_IMPORTED_MODULE_0__["pvifa"])({ term_in, year_in, d_i_year_in, i_in, d_i_in }));

};

// present value interest factor of annuity
const pvifa_ = ({ term_in, year_in, d_i_year_in, i_in, d_i_in }) => {
  if (interet_rate() == 0) return Object(_simple_loan_cul_js__WEBPACK_IMPORTED_MODULE_0__["term"])({ term_in }) - Object(_simple_loan_cul_js__WEBPACK_IMPORTED_MODULE_0__["year"])({ year_in }) + 1;else
  return (1 - Object(_simple_loan_cul_js__WEBPACK_IMPORTED_MODULE_0__["v_pow_term_left"])({ year_in, d_i_year_in, i_in, d_i_in, term_in })) / Object(_simple_loan_cul_js__WEBPACK_IMPORTED_MODULE_0__["interest_rate"])({ year_in, d_i_year_in, i_in, d_i_in });
};
...
const repayment_ = ({ year_in, missed_repayment_year_in, skip_interest_in, principal_in, d_i_year_in, i_in, d_i_in, term_in }) => {
  ...
  } else return Object(_simple_loan_cul_js__WEBPACK_IMPORTED_MODULE_0__["repayment_due"])({ year_in, term_in }) * Object(_simple_loan_cul_js__WEBPACK_IMPORTED_MODULE_0__["repayment_amount"])({ term_in, year_in, principal_in, d_i_year_in, i_in, d_i_in, missed_repayment_year_in, skip_interest_in });
};
