...
export const repayment_amount = ({ term_in, year_in, principal_in, d_i_year_in, i_in, d_i_in, missed_repayment_year_in, skip_interest_in }) => {
...
export const pvifa = ({ term_in, year_in, d_i_year_in, i_in, d_i_in }) => {
...
export const v_pow_term_left = ({ year_in, d_i_year_in, i_in, d_i_in, term_in }) => Math.pow(v({ year_in, d_i_year_in, i_in, d_i_in }), term({ term_in }) - year({ year_in }) + 1);
